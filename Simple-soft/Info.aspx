<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Info.aspx.vb" Inherits="News" %>
...
<body>
	...
	<table id="tblConfigurations" runat="server" border="0" width="188" class="CBorder" cellspacing="5" style="font-size: 8pt; margin-top:20px;">
		...
		<tr><td>11. <a href="Event.htm" target="_parent">Учет мероприятий</a></td></tr>
        ...
        <tr><td>35. <a href="CarService.htm" target="_parent">Автосервис</a></td></tr>
