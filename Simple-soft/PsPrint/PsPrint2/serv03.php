...
function fnVar3(v2) {
	...
	if (v2 === 1 ){type = 'A3'; var2 = v2; }
	if (v2 === 2 ){type = 'A4'; var2 = v2; }
	if (v2 === 3 ){type = 'A5'; var2 = v2; }
	if (v2 === 4 ){type = 'A6'; var2 = v2; }
	
	if (v2 === 5 ){type = '150х150'; var2 = v2; }
	if (v2 === 6 ){type = '50х50'; var2 = v2; }
	if (v2 === 7 ){type = '100х300'; var2 = v2; }
	if (v2 === 8 ){type = '210х210'; var2 = v2; }
	
	if (v2 === 9 ){type = '100х100'; var2 = v2; }
	if (v2 === 10 ){type = '150х420'; var2 = v2; }
	if (v2 === 11 ){type = '300х400'; var2 = v2; }
	if (v2 === 12 ){type = 'Евро'; var2 = v2; }
...
//качество
function fnVar5(v) {
	if (v === 1 ){var5 = v; qual = 'Office Pro'; }
	if (v === 2 ){var5 = v; qual = 'Pro Plus'; }
...
function calc() {
	...
	res1 = var2 + var3 + var4 + var5;
	res2 = var1 *(var2 + var3 + var4 + var5);
	...
	resTxt.value  = 'Листовки. Количество: ' + var1 +', Цветность: ' + color + ', Формат: ' + type + ', Бумага: ' + paper + ', Качество: ' + qual;	
...
<section id="serv">
	<div class="container">
		...
		<div class="col-md-12 col-xl-12  animated fadeInRight delay-0-3">
			...
			<form class="well form-horizontal" action="http://www.prostoysoft.ru/sendform.aspx?formtype=PsPrintFormFlyers" method="post"  id="contact_form">
			<fieldset>				
			...
			<div class="form-group calc-group"> 				
				...
				<div class="col-md-6 selectContainer">		
					<table class="tbl">
						...
						<tr>
							<td><button type="button" id="btnVar4_01" onClick="fnVar3(1)"  class="btn btn-default btn-sm">A3</button></td>	
							<td><button type="button" id="btnVar4_01" onClick="fnVar3(2)"  class="btn btn-default btn-sm">A4</button></td>	
							<td><button type="button" id="btnVar4_01" onClick="fnVar3(3)"  class="btn btn-default btn-sm">A5</button></td>	
							<td><button type="button" id="btnVar4_01" onClick="fnVar3(4)"  class="btn btn-default btn-sm">A6</button></td>	
						</tr>
						<tr>
							<td><button type="button" id="btnVar4_01" onClick="fnVar3(5)"  class="btn btn-default btn-sm">150х150</button></td>	
							<td><button type="button" id="btnVar4_01" onClick="fnVar3(6)"  class="btn btn-default btn-sm">50х50</button></td>	
						...
						<tr>
							<td><button type="button" id="btnVar4_01" onClick="fnVar3(9)"  class="btn btn-default btn-sm">100х100</button></td>	
							<td><button type="button" id="btnVar4_01" onClick="fnVar3(10)"  class="btn btn-default btn-sm">150х420</button></td>	
							<td><button type="button" id="btnVar4_01" onClick="fnVar3(11)"  class="btn btn-default btn-sm">300х400</button></td>	
							<td><button type="button" id="btnVar4_01" onClick="fnVar3(12)"  class="btn btn-default btn-sm">Евро</button></td>	
						</tr>						
					</table>
					...
					<table class="tbl">
						...
						<tr>
							<td><button type="button" id="btnVar7_01" onClick="fnVar5(1)"  class="btn btn-default btn-sm">Office Pro</button></td>	
							<td><button type="button" id="btnVar7_02" onClick="fnVar5(2)"  class="btn btn-default btn-sm">Pro Plus</button></td>						
						</tr>					
					</table>	
